...
class CompoundInterestCalcPage:
    ...
    def get_principal_amount_edit_txt(self):
        return self.driver.find_element(By.XPATH, "//*[@id='principleInput']")

    def get_monthly_deposit_edit_txt(self):
        return self.driver.find_element(By.XPATH, "//*[@id='monthlyDepositInput']")
    ...
    def get_annual_interest_rate_edit_txt(self):
        return self.driver.find_element(By.XPATH, "//*[@id='interestRateInput']")

    def get_calc_btn(self):
        return self.driver.find_element(By.XPATH, "//*[@text='CALCULATE']")

    def get_total_principal_txt_view(self):
        return self.driver.find_element(By.XPATH, "//*[@id='totalPrincipalResult']")

    def get_interest_amount_txt_view(self):
        return self.driver.find_element(By.XPATH, "//*[@id='interestAmountResult']")

    def get_maturity_value_txt_view(self):
        return self.driver.find_element(By.XPATH, "//*[@id='totalResult']")

    def get_apy_txt_view(self):
        return self.driver.find_element(By.XPATH, "//*[@id='apyResult']")
